    ...
    return (React.createElement("div", { className: "kb-col-body" },
        React.createElement("div", { className: "kb-col-scroll" },
            React.createElement(ConnectedDroppable, { droppableId: _.id, type: type, direction: "vertical" }, function (provided, snapshot) { return (React.createElement("div", __assign({ ref: provided.innerRef, className: "kb-col-drop", style: getColumnBodyStyle(snapshot.isDraggingOver) }, provided.droppableProps),
                _.cards.map(function (card, index) { return (React.createElement(KanbanCard, { _: card, i: index, key: card.id })); }),
...
function KbColumnDraggable(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(PublicDraggable, { draggableId: _.id, index: i }, function (provided, snapshot) { return (React.createElement("div", __assign({ ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { className: "kb-col-header", style: getColumnHeaderStyle(snapshot.isDragging, provided.draggableProps.style) }),
        ...
        React.createElement("div", { className: "kb-scroll" },
            React.createElement(DragDropContext, { onDragEnd: onDragEnd },
                React.createElement(ConnectedDroppable, { droppableId: "board", type: "COLUMN", direction: "horizontal", ignoreContainerClipping: true, isCombineEnabled: false }, function (provided, snapshot) { return (React.createElement("div", __assign({ ref: provided.innerRef, className: "kb-header", placeholder: "kb-header", style: getBoardHeaderStyle(snapshot.isDraggingOver) }, provided.droppableProps),
                    bc.columns.map(function (column, index) { return (React.createElement(KbColumnDraggable, { _: column, key: column.id, i: index })); }),
                    provided.placeholder)); })),
...
function KanbanCard(props) {
    ...
    var bc = useContext(BoardContext);
    return (React.createElement(PublicDraggable, { draggableId: _.id, index: i }, function (provided, snapshot) { return (React.createElement("div", __assign({ ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { className: "kb-card", style: getCardStyle(snapshot.isDragging, provided.draggableProps.style) }), _.elem ? _.elem : React.createElement("div", null, "You must put a \"header\" element"))); }));
}
